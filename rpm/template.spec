...
%global pkg_name eigen_stl_containers
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-eigen-stl-containers
Version:        1.1.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Chris Lalancette <clalancette@osrfoundation.org> - 1.1.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Chris Lalancette <clalancette@osrfoundation.org> - 1.1.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Chris Lalancette <clalancette@osrfoundation.org> - 1.1.0-1
- Autogenerated by Bloom
